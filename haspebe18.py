...
#--------------------------------------------------------
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'MID IH HERE'}
                cl.sendMessage(msg)
            elif cms(msg.text,["creator","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'MID IN HERE'}
...
def autoSta():
    ...
    while True:
        try:
		   ...
		   for posts in ki2.activity(1)["result"]["posts"]:
		   for posts in ki3.activity(1)["result"]["posts"]:
		   for posts in ki4.activity(1)["result"]["posts"]:
		   for posts in ki5.activity(1)["result"]["posts"]:
		   for posts in ki6.activity(1)["result"]["posts"]:
		   for posts in ki7.activity(1)["result"]["posts"]:
		   for posts in ki8.activity(1)["result"]["posts"]:
		   for posts in ki9.activity(1)["result"]["posts"]:
		   for posts in ki10.activity(1)["result"]["posts"]:
		   for posts in ki11.activity(1)["result"]["posts"]:
		   for posts in ki12.activity(1)["result"]["posts"]:
		   for posts in ki13.activity(1)["result"]["posts"]:
		   for posts in ki14.activity(1)["result"]["posts"]:
		   for posts in ki15.activity(1)["result"]["posts"]:
		   for posts in ki16.activity(1)["result"]["posts"]:
		   for posts in ki17.activity(1)["result"]["posts"]:
		   for posts in ki18.activity(1)["result"]["posts"]:
                   ...
                   if wait["commentOn"] == True:
                      if posts["userInfo"]["writerMid"] in wait["commentBlack"]:
                         pass
						  ...
						  ki.commnet(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"],wait["comment"]) 
